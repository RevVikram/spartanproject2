...
while True:
    try:
        client = MongoClient("mongodb://db.rrajendran.devops106:27017")
        break
    except Exception as e:
        print("Trying to create a connection to db")
        time.sleep(2)
...
def home_page():
    with open("log/user_logbook.txt", "a+") as user_action_file:
...
def spartan_add():
    ...
    spartan_object = Spartan(spartan_id, first_name, last_name, birth_day, birth_month, birth_year,
                                     course, stream)
